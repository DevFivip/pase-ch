            ...
            <div class="view view-main safe-areas">
                ...
                <div class="page mylogin back1 text-align-center page-current">
                    ...
                    <div class="page-content">
                        ...
                        <div class="block no-margin-vertical"><a class="button button-large button-outline color-purple" href="javascript:open()">
                                <!---->
                            ...
                            <div class="page">
                                <div class="navbar">
                                    ...
                                    <div class="navbar-inner sliding">
                                        ...
                                        <!---->
                                        <!---->
                                        <div class="right"><a class="link popup-close" href="javascript:open()">
                                                <!---->
                                                <!---->Cerrar
                                            </a></div>
                                    </div>
                        ...
                        <div id="modal-resultados" class="popup resultado-popup" style="display: none;">
                            <div class="page softgray" data-name="home">
                                <!---->
                                <div class="page-content" style="top:0px !important">
                                    <!---->
                                    <!---->
                                    <!---->
                                    ...
                                    <div class="block conten no-padding">
                                        <div class="card pullmeup text-align-center">
                                            ...
                                            <!---->
                                            <!---->
                                            <div class="block text-align-center no-margin-top margin-bottom-half identidad">
                                                <div> <span id="tipo_documento">RUN</span> <span id="nro_documento">********.643-8</span></div>
                                                <div class="apellidos"><span id="apellido_primero">MA*******</span> <span id="apellido_segundo">VA*******</span></div>
                                                <div class="nombres"><span id="nombre_primero">Ces**</span></div>
                                            </div>
                                        </div>
                                        <div class="block reescanea no-margin-vertical"><a class="button button-large button-raised button-outline color-purple" href="javascript:resultados()">
                                                <!---->
                                                <!----><svg class="svg-inline--fa fa-qrcode fa-w-14 fa-lg margin-right-half" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="qrcode" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                                    <path class="" fill="currentColor" d="M0 224h192V32H0v192zM64 96h64v64H64V96zm192-64v192h192V32H256zm128 128h-64V96h64v64zM0 480h192V288H0v192zm64-128h64v64H64v-64zm352-64h32v128h-96v-32h-32v96h-64V288h96v32h64v-32zm0 160h32v32h-32v-32zm-64 0h32v32h-32v-32z"></path>
                        ...
                        <div id="dialogo" class="dialog dialog-buttons-1 " style="display: none;">
                            ...
                            <div class="dialog-buttons"><a href="javascript:dialogo()" class="dialog-button dialog-button-bold">OK</a></div>
                        </div>
